---
title: "Oral Cancer Risk Index (OCRI) Test Report"
output: pdf_document
params:
  choice: NA
  rda: NA
...
OCRI indicates the probability of oral cancer in a specific sample, 
...
The value needs to be interpreted in accordance with clinical information. It is generated based on DNA values of exfoliative cells from oral mucosa.
...
We collected DNA ploidy data of exfoliative cells, histopathology data and clinical data from 120 normal subjects, 110 oral leukoplakia and 134 oral squamous cell carcinoma. OCRI was calculated using data reconstruction and machine learning techniques (sensitivity=1.00, specificity>0.99).


*OCRI>0.5 is labeled as red, suggesting a high risk of cancer. OCRI<0.5 is labeled as blue, suggesting a low risk of cancer.


Reference: Liu Y, et al. Quantitative Prediction of Oral Cancer Risk in Patients with Oral Leukoplakia. ONCOTARGET 2017.
...
Although OCRI is developed with histopathology as the golden standard, its accuracy is still subject to variations due to sampling, staining and data collection. If OCRI>0.5, it is recommended to repeat the test and consult a pathologist.
...
FOR RESEARCH USE ALONE, NOT INTENDED FOR CLINICAL USE

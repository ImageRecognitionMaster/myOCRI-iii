...
length(which(label.c.as.c > 0.6))
length(which(label.c.as.c <= 0.6))
summary(label.c.as.c)
label.c.as.c[which(label.c.as.c <= 0.6)]


length(which(label.n.as.c > 0.6))
length(which(label.n.as.c <= 0.6))
summary(label.n.as.c)
label.n.as.c[which(label.n.as.c > 0.6)]

label.n.as.c[which(label.n.as.c > 0.4)]
##Summary of oscc
...
length(which(svmPred.k.prob$c > 0.6))
#length(which(svmPred.k.prob$n > 0.5))

summary(svmPred.k.prob$c)
...
svmPred.k.prob$c[rownames(svmPred.k.prob) == "ID_128141"]
